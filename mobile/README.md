...
- `agroscan_baseline_float.tflite` — classification **+** conv features for Grad-CAM (exported from `models/jalon5_weak_classes_best.keras` by default; filename kept for compatibility)
